...
public class InterfazAdministrador  extends HttpServlet {
  ...
  void enviarPublicidad(int id) {
    ...
    out.println("<form method='GET' action='Administrador'>");
  ...
  void editarCuenta(int id, HttpServletRequest request) {
    ...
    boolean valido = cadmin.modificarUsuario("administrador", id, username, email, passwd);
