...
public class InterfazAutor extends HttpServlet {
  ...
  void editInfo(int id) {
    ...
    out.println("<form method='GET' action='Autor'>");
  ...
  void editarCuenta(int id, HttpServletRequest request) {
    ...
    boolean valido = cadmin.modificarUsuario("autor", id, username, email, passwd);
  ...
  void verPerfil(int id){
    ...
    out.println("<h2>Articulos a Publicar</h2>");
